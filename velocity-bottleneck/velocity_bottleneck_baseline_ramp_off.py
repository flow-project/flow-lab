...
if __name__ == '__main__':
    ...
    path_for_mean_results = results_dir + "ramp_off_mean" + time.strftime("%Y-%m-%d::%H:%M") + ".csv"
    path_for_each_results = results_dir + "ramp_off_each" + time.strftime("%Y-%m-%d::%H:%M") + ".csv"
